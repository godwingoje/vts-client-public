...
export default function VisitorProfile() {
  ...
  return (
    <div className="flex min-h-[calc(100dvh-6rem)] w-full items-center justify-center bg-white px-4 py-6 sm:px-6 md:min-h-0 md:px-10 md:py-0 dark:bg-slate-800">
      <main className="flex w-full max-w-xl flex-col">
        ...
        <section className="mt-6 w-full rounded-2xl border border-slate-200 bg-slate-50 p-5 text-left shadow-sm md:p-6 dark:border-slate-700 dark:bg-slate-800">
